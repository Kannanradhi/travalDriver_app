...
/*
        if (ServiceConstant.ACTION_TAG_RIDE_REQUEST.equalsIgnoreCase(action)) {
           *//* notificationIntent = new Intent(GCMNotificationIntentService.this, DriverAlertActivity.class);
            notificationIntent.putExtra(DriverAlertActivity.EXTRA, data);
            notificationIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);*//*

            Intent intent1 = new Intent(GCMNotificationIntentService.this, Splash.class);
        ...
        if (action.equalsIgnoreCase(ServiceConstant.ACTION_TAG_RIDE_REQUEST)) {
            ...
            System.out.println("***********venki****1***ACTION_TAG_RIDE_REQUEST***"+ServiceConstant.ACTION_TAG_RIDE_REQUEST);
        }else if(ServiceConstant.ACTION_TAG_NEW_TRIP.equalsIgnoreCase(action)) {
            System.out.println("---------------inside new trip--------gcm----------");
