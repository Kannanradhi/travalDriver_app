...
public class HomePage extends Activity implements GoogleApiClient.ConnectionCallbacks,
        ...
        mRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
             ...
             /*   Intent intent = new Intent(HomePage.this, RegisterPageWebview.class);
               ...
               /* RelativeLayout parentRl=(RelativeLayout)findViewById(R.id.parentLayout);
                SnackFlashBar snackFlashBar = new SnackFlashBar(HomePage.this,getResources().getString(R.string.app_name), getResources().getString(R.string.driver_details_address_empty_error),parentRl, "error");*/
//                snackFlashBar.SnackBar(getResources().getString(R.string.app_name), getResources().getString(R.string.driver_details_address_empty_error),parentRl, "error");
