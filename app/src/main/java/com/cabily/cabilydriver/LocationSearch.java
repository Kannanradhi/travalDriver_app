...
import com.app.dao.EstimateDetailPojo;
...
public class LocationSearch extends AppCompatActivity {
    ...
    private String Slatitude = "", Slongitude = "", Sselected_location = "",near_latitude="",near_longitude="";
        ...
        et_search.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (isInternetPresent) {
                    ...
                    CitySearchRequest(ServiceConstant.place_search_url + et_search.getText().toString().toLowerCase().replace("%","").replace(" ","%20")+"&radius=500&location="+near_latitude+","+near_longitude);
                } else {
                    alert_layout.setVisibility(View.VISIBLE);
                    alert_textview.setText(getResources().getString(R.string.alert_nointernet));
                }
    ...
    private void initialize() {
        ...
        near_latitude = intent.getStringExtra("nearLatitude");
        near_longitude = intent.getStringExtra("nearLongitude");
    }
    ...
    private void LatLongRequest(String Url) {
        ...
        dialog_title.setText("Processing");
