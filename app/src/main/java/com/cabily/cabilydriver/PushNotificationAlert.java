...
//                    db.clearTable();
                    ...
                    Intent i = new Intent(PushNotificationAlert.this, NavigationDrawerNew.class);
    ...
    private void initialize() {
        session=session = new SessionManager(getApplicationContext());
        Intent i = getIntent();
        ...
        System.out.println("----------jai-----ride_id"+rideid);
