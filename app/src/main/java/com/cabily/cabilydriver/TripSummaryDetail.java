...
public class TripSummaryDetail extends SubclassActivity {
    ...
    private TextView Tv_tripdetail_rideId, TV_drop_time, Tv_tripdetail_address, Tv_tripdetail_pickup, Tv_tripdetail_drop, Tv_tripdetail_ride_distance,
            Tv_tripdetail_timetaken, Tv_tripdetail_waitingtime, Tv_tripdetail_total_paid, Tv_tripdetail_total_amount_paid,   Tv_wallet_uage, Tv_coupon_discount,Tv_rideDate;
    ...
    private String Str_Username = "", Str_useremail = "", sRideDate = "",Str_pickup_date = "", Str_drop_date = "", Str_phoneno = "", Str_pickup_time = "", Str_userimg = "", Str_userrating = "", Str_rideid = "", Str_pickuplocation = "", Str_pickup_lat = "", Str_pickup_long = "";
    ...
    private LinearLayout Rl_layout_amount_status,Rl_layout_Tripststus;
    private TextView Tv_trip_paid_status,Tv_trip_status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Rl_layout_tripdetail_back_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!type.equalsIgnoreCase("noti")) {
                    ...
                    Intent i = new Intent(TripSummaryDetail.this, NavigationDrawerNew.class);
        ...
        Bt_Continue_Ride.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent trip_intent = new Intent(TripSummaryDetail.this, TripPage.class);
...
*/
    ...
    private void initialize() {
        ...
        Rl_layout_amount_status = (LinearLayout) findViewById(R.id.layout_tripdetail_payment_status);
        Rl_layout_Tripststus = (LinearLayout) findViewById(R.id.layout_trip_summery_details_status);
    ...
    private void showfaresummerydetails() {
        ...
        View view = LayoutInflater.from(TripSummaryDetail.this).inflate(R.layout.fare_summery_alert_dialog, null);
        ...
        if (str_req_payment.matches("Enable")) {
            layout_request_payment.setVisibility(View.VISIBLE);
            Tv_reqest.setText(TripSummaryDetail.this.getResources().getString(R.string.lbel_fare_summery_requestpayment));
        ...
        layout_receive_cash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(TripSummaryDetail.this, PaymentPage.class);
        ...
        layout_request_payment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isInternetPresent) {
                    ...
                    if (Tv_reqest.getText().toString().equalsIgnoreCase(TripSummaryDetail.this.getResources().getString(R.string.lbel_fare_summery_requestpayment))) {
                        ...
                        Intent intent = new Intent(TripSummaryDetail.this, RatingsPage.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                    }
    ...
    public void loadMap(GoogleMap arg) {
        ...
        googleMap.setMapStyle(
                MapStyleOptions.loadRawResourceStyle(
                        TripSummaryDetail.this, R.raw.mapstyle));
    ...
    private void Alert1(String title, String message) {
        ...
        mDialog.setPositiveButton(getResources().getString(R.string.alert_label_ok), new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(TripSummaryDetail.this, LoadingPage.class);
    ...
    private void postRequest_tripdetail(String Url) {
        ...
        mRequest = new ServiceRequest(TripSummaryDetail.this);
            ...
            public void onCompleteListener(String response) {
                ...
                try {
                    ...
                    if (jobject.length() > 0) {
                        ...
                        sRideDate = jsonObject.getString("ride_date");
...
*/
                        ...
                        if (isPickUpAvailable) {
                            if (!"".equalsIgnoreCase(sInvoiceSrc) && sInvoiceSrc != null) {
                                ...
                                Picasso.with(TripSummaryDetail.this).load(sInvoiceSrc).resize(width, 300).placeholder(R.drawable.aaaaa).into(Iv_routeMap);
                            } else {
