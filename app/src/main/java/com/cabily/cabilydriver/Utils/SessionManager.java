...
public class SessionManager {
    ...
    public static final String KEY_RIDE_TYPE = "ridetype";
    ...
    public static final String KEY_SYNC_JOB_ID = "jobid";
    ...
    public HashMap<String, String> getuserStatus() {
        HashMap<String, String> code = new HashMap<String, String>();
        code.put(KEY_USERSTATUS, pref.getString(KEY_USERSTATUS, ""));
        return code;
    }
    ...
    public HashMap<String, String> getchatNotify() {
        HashMap<String, String> code = new HashMap<String, String>();
        code.put(KEY_CHAT_NOTIFY, pref.getString(KEY_CHAT_NOTIFY, ""));
        return code;
    }

    public void setchatNotify(String chatNotify) {
        editor.putString(KEY_CHAT_NOTIFY, chatNotify);
        editor.commit();
    }

    public HashMap<String, String> getrideType() {
        HashMap<String, String> code = new HashMap<String, String>();
        code.put(KEY_RIDE_TYPE, pref.getString(KEY_RIDE_TYPE, ""));
        return code;
    }

    public void setrideType(String rideType) {
        editor.putString(KEY_RIDE_TYPE, rideType);
        editor.commit();
    }

    public HashMap<String, String> getrideId() {
        HashMap<String, String> code = new HashMap<String, String>();
        code.put(KEY_RIDE_ID, pref.getString(KEY_RIDE_ID, ""));
        return code;
    }

    public void setrideId(String rideId) {
        editor.putString(KEY_RIDE_ID, rideId);
        editor.commit();
    }
    ...
    public void set_driverdetails(String category,String vechicle_number, String reviews) {
        editor.putString(KEY_CATEGORY, category);
        editor.putString(KEY_VEHICLENO, vechicle_number);
        editor.putString(KEY_REVIEWS, reviews);
        editor.commit();
    }
    public HashMap<String, String> get_driverdetails() {
        HashMap<String, String> catID = new HashMap<String, String>();
        catID.put(KEY_CATEGORY, pref.getString(KEY_CATEGORY, ""));
        catID.put(KEY_VEHICLENO, pref.getString(KEY_VEHICLENO, ""));
        catID.put(KEY_REVIEWS, pref.getString(KEY_REVIEWS, ""));
        return catID;
    }


    public void setjobid(int job) {
        editor.putInt(KEY_SYNC_JOB_ID, job);
        editor.commit();
    }

    public int getjobid() {
        return pref.getInt(KEY_SYNC_JOB_ID, 0);
