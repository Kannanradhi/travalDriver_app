...
public class DriverAlertAdapter extends BaseAdapter {
    ...
    private View.OnClickListener acceptBtnlistener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (DashBoardDriver.myLocation != null) {
                jsonParams.put("driver_lat", "" + DashBoardDriver.myLocation.getLatitude());
                jsonParams.put("driver_lon", "" + DashBoardDriver.myLocation.getLongitude());
                System.out.println("rideid---------" + rider_id);
                System.out.println("driver_id---------" + driverId);
                System.out.println("driver_lat---------" + DashBoardDriver.myLocation.getLatitude());
                System.out.println("driver_lon---------" + DashBoardDriver.myLocation.getLongitude());
            }
