...
public class UserListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.chatNotifyDot = (View) itemView.findViewById(R.id.chat_notify_dot);
        ...
        if(list.get(position).getChatNotify().equalsIgnoreCase("1"))
        {
            holder.chatNotifyDot.setVisibility(View.VISIBLE);
        }else
        {
            holder.chatNotifyDot.setVisibility(View.INVISIBLE);
        }
